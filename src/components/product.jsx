        ...
        <Card className="w-full max-w-[26rem] shadow-2xl fade-in">
            ...
            <CardBody>
                <div className="mb-3 flex items-center justify-between">
                    <Tooltip content={product.title} animate={{
                        mount: { scale: 1, y: 0 },
                    ...
                    <Tooltip content={product.rating.count + ' reviews'} animate={{
                    mount: { scale: 1, y: 0 },
                    unmount: { scale: 0, y: 25 },
                }} className='w-fit' >
                    <Typography
            ...
            <CardFooter className="pt-3">
                <Button size="lg" variant="text" style={{color:'var(--primary-color)'}} fullWidth={true}>
                    Add to Cart
                </Button>
            </CardFooter>
        </Card>
